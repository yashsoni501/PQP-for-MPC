...
void input(float *Qp_inv, float *Fp, float *Mp, float *Gp, float *Kp, float *x, float *D, float *theta, float *Z, int N, int M)
{
	FILE *fptr;
	float tmp;
...
int main()
{
	...
	input(Qp_inv, Fp, Mp, Gp, Kp, x, D, theta, Z, N, M);
	return 0;
